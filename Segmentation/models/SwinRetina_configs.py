...
def get_swin_res34_cv_110_111_33_true_cfg():
    cfg = ml_collections.ConfigDict()
    cfg.cnn_backbone = "resnet34"
    cfg.cnn_pyramid_fm  = [64, 128, 256]
    cfg.swin_pyramid_fm = [96, 192, 384]
...
def get_swin_res50_cv_110_111_33_true_cfg():
    cfg = ml_collections.ConfigDict()
...
def get_swin_res50_cv_11_11_33_true_cfg():
    cfg = ml_collections.ConfigDict()
    cfg.cnn_backbone = "resnet50"
    cfg.cnn_pyramid_fm  = [256,512,1024]
    cfg.swin_pyramid_fm = [96, 192, 384]
...
# Ablation
# ----------------------------------------------------------------------------------#
def get_swin_res18_cv_120_221_66_true_cfg():
    cfg = ml_collections.ConfigDict()
    cfg.cnn_backbone = "resnet18"
    cfg.cnn_pyramid_fm  = [64, 128, 256]
    cfg.swin_pyramid_fm = [96, 192, 384]
...
# ----------------------------------------------------------------------------------#
def get_swin_res101_cv_120_221_66_true_cfg():
    cfg = ml_collections.ConfigDict()
    cfg.cnn_backbone = "resnet101"
    cfg.cnn_pyramid_fm  = [256,512,1024]
    cfg.swin_pyramid_fm = [96, 192, 384]
    cfg.image_size = 224
    cfg.patch_size = 4
